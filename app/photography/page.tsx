    ...
    <main className="min-h-screen flex flex-col bg-gray-50 font-sans">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 py-20">
        <div className="text-center space-y-6 max-w-md">
          <h1 className="text-4xl md:text-5xl font-black font-display text-gray-900 tracking-tight">Photography</h1>
          <p className="text-gray-500 text-lg">
            The photography gallery section is coming soon. Stay tuned for stunning visuals!
          </p>
